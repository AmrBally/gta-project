...
function AnswerFullCall ( { setCallDeclined, setAnsweredFullCall, setOpenedFullCall, setAcceptedCall } )
{
    ...
    return (
        <>
            <div className="w-full h-full flex flex-col justify-between items-center">
                <div className="w-full flex justify-start items-start gap-4 pl-20">
                    ...
                    <div className="flex flex-col justify-start items-start text-white">
                        ...
                        <p className="opacity-50">{showTime ? `${ min }:${ sec < 10 ? "0" + sec : sec }` : "Connecting"}</p>
                    </div>
                </div>

                <div className="w-full flex justify-between items-end px-10 pb-20">
                    <div className="flex flex-col items-center justify-center text-white gap-1" onClick={videoCallHandler}>
                    ...
                    <div className="flex flex-col items-center justify-center text-white gap-1" onClick={muteHandler}>
                        <button className={`${ muted ? "bg-[#d0d0d0]" : "bg-[#3a3a3b]" } w-[50px] h-[50px] rounded-full flex items-center justify-center`}>
                    ...
                    <div className="flex flex-col items-center justify-center text-white gap-1">
                        <button className="bg-[#eb5545] w-[50px] h-[50px] rounded-full flex items-center justify-center" onClick={() => setCallDeclined( true )}>
            ...
            <HomeBar bottom={"30px"} setAnsweredFullCall={setAnsweredFullCall} setOpenedFullCall={setOpenedFullCall} setAcceptedCall={setAcceptedCall} />
        </>
    );
}
